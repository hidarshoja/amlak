    ...
    <div>
		...
		<nav class="mb-3 pt-md-3" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/rent">ملک برای اجاره</a></li>
            <li class="breadcrumb-item active" aria-current="page">اقامتگاه ویلایی</li>
          </ol>
        </nav>
          ...
          <div class="col-lg-7">
            <div class="d-flex flex-column">
              ...
              <div class="order-lg-2 order-1">
                <h1 class="h2 mb-2">آپارتمان 85 متری</h1>
                <p class="mb-2 pb-1 fs-base">تهران، سعادت آباد، خیابان سرو غربی، مجتمع نواب</p>
                <ul class="d-flex mb-4 pb-lg-2 list-unstyled">
                  ...
                  <li><b>85 </b>مترمربع</li>
                </ul>
              </div>
            </div>
            <!-- Overview-->
            <h2 class="h5">توضیحات</h2>
            <p class="mb-4 pb-2">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
            <!-- Rental agent-->
            <h2 class="h5">املاک امپراتور</h2>
            <div class="card card-horizontal">
              <div class="card-img-top bg-position-center-x" style="background-image: url(/real-estate/agents/01.jpg);"></div>
              <blockquote class="blockquote card-body p-4">
                <p class="mb-4">لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت بوده است. لورم ایپسوم ساختار چاپ و متن را در بر می گیرد. لورم ایپسوم استاندارد صنعت بوده است.</p>
                <footer class="d-flex justify-content-between">
                  <div class="pe-3">
                    <h6 class="mb-0">بنفشه کریمی</h6>
                    <div class="text-muted fw-normal fs-sm mb-3">نماینده گروه امپراتوری املاک</div><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-facebook"></i></a><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-twitter"></i></a><a class="btn btn-icon btn-light-primary btn-xs shadow-sm rounded-circle me-2 mb-2" href="#"><i class="fi-instagram"></i></a>
                  </div>
          ...
          <aside class="col-lg-5">
            <div class="ps-lg-5">
              <div class="d-flex align-items-center justify-content-between mb-3">
                <div><span class="badge bg-success me-2 mb-2">تایید شده</span><span class="badge bg-info me-2 mb-2">جدید</span></div>
              ...
              <h3 class="h5 mb-2">اجاره ملک:</h3>
              <h2 class="h3 mb-4 pb-2">2,150,000 تومان<span class="d-inline-block ms-1 fs-base fw-normal text-body">/ماهیانه</span></h2>
              <!-- Property details-->
              <div class="card border-0 bg-secondary mb-4">
                <div class="card-body">
                  <h5 class="mb-0 pb-3">مشخصات</h5>
                  <ul class="list-unstyled mt-n2 mb-0">
                    <li class="mt-2 mb-0"><b>نوع: </b>آپارتمان</li>
                    <li class="mt-2 mb-0"><b>متراژ (مترمربع): </b>85 مترمربع</li>
                    <li class="mt-2 mb-0"><b>سال ساخت: </b>1380</li>
                    <li class="mt-2 mb-0"><b>تعداد اتاق: </b>4</li>
                    <li class="mt-2 mb-0"><b>تعداد سرویس بهداشتی: </b>2</li>
                    <li class="mt-2 mb-0"><b>پارکینگ: </b>دارد</li>
                    <li class="mt-2 mb-0"><b>حیوانات خانگی مجاز: </b>فقط گربه</li>
                  </ul>
                </div>
              </div><a class="btn btn-lg btn-primary w-100 mb-3" href="#">برای مشاهده رزرو کنید</a><a class="d-inline-block mb-4 pb-2 text-decoration-none" href="#"><i class="fi-help me-2 mt-n1 align-middle"></i>سوالات متداول</a>
              <!-- Amenities-->
              <div class="card border-0 bg-secondary mb-4">
                <div class="card-body">
                  <h5>امکانات رفاهی</h5>
                  ...
                  </div><a class="collapse-label collapsed d-inline-block mt-3" href="#seeMoreAmenities" data-bs-toggle="collapse" data-bs-label-collapsed="مشاهده بیشتر" data-bs-label-expanded="بستن" role="button" aria-expanded="false" aria-controls="seeMoreAmenities"></a>
                </div>
              </div>
