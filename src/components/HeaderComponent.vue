<template>
    <div>
        ...
        <div class="container"><a class="navbar-brand ms-3 ms-xl-4 logo" href="real-estate-home-v1.html">
            <img class="d-block" src="/logo/sorena.png" width="30" alt="Finder"></a>
          ...
          <div class="collapse navbar-collapse order-lg-2" id="navbarNav">
            <ul class="navbar-nav navbar-nav-scroll" style="max-height: 35rem;">
              ...
              <!-- Menu items-->
                  ...
                  <li class="nav-item dropdown"><a class="nav-link dropdown-item" href="/">صفحه اصلی</a></li>
              ...
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">املاک</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/rent">ملک برای اجاره</a></li>
                  <li><a class="dropdown-item" href="/sell">ملک برای فروش</a></li>
				          <li><a class="dropdown-item" href="/detailsView">جزئیات</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">حساب کاربری</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/profile">اطلاعات حساب کاربری</a></li>
                  <li><a class="dropdown-item" href="/userPassword">گذرواژه و امنیتی</a></li>
                  <li><a class="dropdown-item" href="/myProperty">مشخصات من</a></li>
                  <li><a class="dropdown-item" href="/liveHome">لیست مورد علاقه</a></li>
                  <li><a class="dropdown-item" href="/comments">نظرات</a></li>
                  <li><a class="dropdown-item" href="/notification">اطلاعیه ها</a></li>
				          <li><a class="dropdown-item" href="/auth/login">ورود به اکانت</a></li>
                  <li><a class="dropdown-item" href="/auth/register">ثبت نام</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">ثبت ملک</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="/record">ثبت</a></li>
                  <li><a class="dropdown-item" href="/plan">ارتقا</a></li>
              ...
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">صفحات</a>
                <ul class="dropdown-menu">
                  ...
                  <li class="dropdown"><a class="dropdown-item dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">صفحات وبلاگ</a>
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="/blog">بلاگ</a></li>
                      <li><a class="dropdown-item" href="/detailsBlog">جزئیات</a></li>
                    </ul>
                  </li>
                  <li><a class="dropdown-item" href="/contactUs">تماس با ما</a></li>
                  <li><a class="dropdown-item" href="/support">سوالات متداول</a></li>
                  <li><a class="dropdown-item" href="/404">صفحه 404</a></li>
                </ul>
              </li>
